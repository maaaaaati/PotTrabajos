...
Para modelar las pérdidas del diode (por conducción y conmutación) 
\begin{figure}[H]
        \centering
...
\begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{qrr_didtAT25.png}
        \caption{Carga de recuperación en reversa del diode como función de la tasa de cambio de la corriente directa del diodo a 25 °C}
        \label{fig:qrr25}
    \end{figure}

\begin{figure}[H]
        \centering
        \includegraphics[width=0.8\linewidth]{qrr_didtAT125.png}
        \caption{Carga de recuperación en reversa del diode como función de la tasa de cambio de la corriente directa del diodo a 125 °C}
        \label{fig:qrr125}
    \end{figure}
