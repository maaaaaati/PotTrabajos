...
IRF540N \cite{IRF540N_ds}, el IRFS7730 \cite{IRFS7730_ds} y el IRF3007 \cite{IRF3007_ds}. A continuación, 
...
\begin{table}[H]
    ...
    \begin{tabularx}{\columnwidth}{
        ...
        \toprule
        Parámetro                                   & IRF540N & IRFS7730 & IRF3007 \\
        \midrule
        $V_{DS,max}~\mathrm{[V]}$                   & $100$   & $75$     & $75$    \\
        $I_{D}~@~25^\circ\mathrm{C}~\mathrm{[A]}$   & $33$    & $195$    & $62$    \\
        $R_{DS(on), max}~\mathrm{[m\Omega]}$        & $44$    & $2.6$    & $12.6$  \\
        $Q_{g}~\mathrm{[nC]}$                       & $71$    & $271$    & $89$    \\
        $R_{\theta JC}~[^\circ\mathrm{C/W}]$        & $1.15$  & $0.40$   & $1.25$  \\
        $P_{D, max}~\mathrm{[W]}$                   & $130$   & $375$    & $120$   \\
        \bottomrule
    \end{tabularx}
...
Por otra parte, los transistores IRFS7730 y el IRF3007 tienen una resistencia de conducción mucho más baja, lo que los convierte
en una mejor alternativa para reducir las pérdidas por conducción. Hay que considerar que el RFS7730 tiene un valor de $Q_{g}$ tres 
veces mayor en comparación con el IRF3007, con lo que en primera instancia tendría mayores pérdidas por conmutación. Sin embargo, se sabe
que las pérdidas por conmutación son menos relevantes y pueden ser controladas al variar la frecuencia de operación; además, el 
RFS7730 tiene una resistencia térmica de juntura a carcasa mucho menor, lo que le permite disipar mejor el calor generado 
por las pérdidas.

\setlength{\parskip}{1em}

En base a lo mencionado, se elige al IRFS7730 como el transistor a utilizar para el diseño del convertidor Buck, ya que 
