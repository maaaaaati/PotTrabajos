...
\subsection{Modelos térmicos}
    ...
    tiene significado físico y representa una interfaz real entre capas del dispositivo; 
    de esta manera, los elementos RC individuales pueden ser asignados a las capas individuales 
    del módulo, y los nodos de la red permiten acceder a las temperaturas internas de la 
    secuencia de capas.
